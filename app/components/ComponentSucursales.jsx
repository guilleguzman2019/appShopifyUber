...
const ComponentSucursales = ({ tienda: initialTienda, onSaveSucursal }) => {
    ...
    const currentSucursales = tienda?.sucursales ? tienda.sucursales.slice(indexOfFirstSucursal, indexOfLastSucursal) : [];
    const totalPages = Math.ceil((tienda?.sucursales?.length || 0) / sucursalesPerPage);

    // Cargar el script de Google Maps
    const { isLoaded, loadError } = useLoadScript({
        googleMapsApiKey: 'AIzaSyDGa5xQES7MMhkvcpIA5Y85QzlVEqL1sJg',
        libraries: ['places'],  // Solo necesitas 'places' si usas Autocomplete
    });
                            ...
                            <div className="col-span-3 space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <input
                                        ...
                                        onChange={(e) => setNewSucursal(prev => ({...prev, latitud: parseFloat(e.target.value) || null}))}
                                        placeholder="Latitud"
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setNewSucursal(prev => ({...prev, longitud: parseFloat(e.target.value) || null}))}
